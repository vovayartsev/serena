...
* **Elixir**  
  ...
  set language to `elixir_dexterity` to instead read a pre-built [Dexter](https://github.com/remoteoss/dexter) index (`.dexter/dexter.db`) — no language server process is launched)
* **Elm**  
